...
export default function RecoveryPoints(props) {
  // STATE
  ...
  const fetch = () => {
    ...
    APi.createAPIEndpoint(APi.ENDPOINTS.RecoveryPoint, filterModel)
      .fetchAll()
      .then((res) => {
  ...
  const save = () => {
    ...
    if (msg) setError(msg);
      ...
      if (model.id) {
        APi.createAPIEndpoint(APi.ENDPOINTS.RecoveryPoint)
